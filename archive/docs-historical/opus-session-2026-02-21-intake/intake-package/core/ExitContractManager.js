 ...
 */
// FIX 2026-02-21: Tightened universal limits for 1m scalping
const UNIVERSAL_LIMITS = {
  hardStopLossPercent: -1.0,      // Per-trade absolute max loss (was -3%, unreachable)
  accountDrawdownPercent: -10.0,  // Force close all if account down 10%
  maxHoldTimeMinutes: 90          // 90 min absolute max hold (was 480)
};
