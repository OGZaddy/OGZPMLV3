...
// REMOVED 2026-02-20: ExecutionRateLimiter - was blocking 95%+ of trades
// See CHANGELOG-2026-02-20-pipeline-unblock.md
...
class OGZPrimeV14Bot {
  constructor() {
    ...
    // REMOVED 2026-02-20: ExecutionRateLimiter was here
    // Gutted entirely - was blocking 95%+ of trades in backtest and adding
    // unnecessary complexity in live mode. MIN_TRADE_CONFIDENCE + position
    // sizing are the real risk controls.
  ...
  handleMarketData(ohlcData) {
    ...
    if (!isNewMinute) {
      ...
      // FIX 2026-02-20: Skip in backtest - causes EMFILE on Windows
      if (process.env.BACKTEST_MODE !== 'true') {
